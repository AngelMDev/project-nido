...
export default class Rect extends PureComponent {
  ...
  render () {
    const { styles: { position: { centerX, centerY }, size: { width, height }, transform: { rotateAngle } }, zoomable, editable } = this.props
    ...
    return (
      <StyledRect
        ...
        onMouseDown={editable && this.startDrag}
        className="rect single-resizer"
        style={style}
      >
        {editable && <div className="rotate" onMouseDown={this.startRotate}><i></i></div>}
        {direction.map(d => {
